...
function () {
  function Mapbox(props) {
    ...
    if (!Mapbox.initialized && console.debug) {
      ...
      var VERSION = typeof "3.3.0" !== 'undefined' ? "3.3.0" : 'untranspiled source';
  ...
  _createClass(Mapbox, [{
    ...
    value: function _create(props) {
      ...
      if ((props.reuseMaps || props.reuseMap) && Mapbox.savedMap) {
        ...
        this._map = this.map = new props.mapboxgl.Map(mapOptions); // Attach optional onLoad function
    ...
    value: function _checkStyleSheet() {
      ...
      try {
        var missingCssWarning = document.querySelector('.mapboxgl-missing-css');
        var isCssLoaded = window.getComputedStyle(missingCssWarning).display === 'none';

        if (!isCssLoaded) {
          // attempt to insert mapbox stylesheet
          var mapboxVersion = this.props.mapboxgl.version;
