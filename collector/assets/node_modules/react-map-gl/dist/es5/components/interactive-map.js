...
var propTypes = Object.assign({}, _staticMap.default.propTypes, {
  ...
  visibilityConstraints: _propTypes.default.shape({
    minZoom: _propTypes.default.number,
    maxZoom: _propTypes.default.number,
    minPitch: _propTypes.default.number,
    maxPitch: _propTypes.default.number
...
function (_PureComponent) {
  ...
  function InteractiveMap(props) {
    ...
    _this._checkVisibilityConstraints = _this._checkVisibilityConstraints.bind(_assertThisInitialized(_this));
  ...
  _createClass(InteractiveMap, [{
    ...
    value: function _checkVisibilityConstraints(props) {
      ...
      for (var propName in props) {
        ...
        var minPropName = "min".concat(capitalizedPropName);
        var maxPropName = "max".concat(capitalizedPropName);
